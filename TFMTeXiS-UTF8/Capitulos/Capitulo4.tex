...
\begin{figure}[H]
    ...
    \node[box, below=of obtener] (sql)
    {\texttt{ejecutar\_consulta\_sql()}};

    \node[box, below=of sql] (buscar)
    {\texttt{buscar\_columnas\_relevantes()}};

    \node[box, below=of buscar] (sqlite)
    {SQLite};
    ...
    \draw[arrow] (obtener) -- (sql);
    \draw[arrow] (sql) -- (buscar);
    \draw[arrow] (buscar) -- (sqlite);
