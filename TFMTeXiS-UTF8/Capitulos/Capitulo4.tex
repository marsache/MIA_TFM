...
El método utilizado para esta extracción de metadatos es \verb|detectar_polirritmias|.
...
El método utilizado para esta extracción de metadatos es \verb|_calcular_tesitura|.
...
El método utilizado para esta extracción de metadatos es \verb|_clasificar_genero_autor|.
...
El método utilizado para esta extracción de metadatos es \verb|_analizar_perspectiva_lirica|.
...
El método utilizado para esta extracción de metadatos es \verb|_extract_notes_and_rests|.
...
El método utilizado para esta extracción de metadatos es \verb|_extract_melody_pitches|.
...
El método utilizado para esta extracción de metadatos es \verb|_analyze_interval_directions|.
...
El método utilizado para esta extracción de metadatos es \verb|_determine_predominant_trend|.
...
El método utilizado para esta extracción de metadatos es \verb|_extract_syllable_duration_mapping|.
