"""
Web frontend for the Ollama + MCP Song Search Agent.
...
app = FastAPI(title="Song Search Agent")
...
async def websocket_endpoint(websocket: WebSocket) -> None:
    ...
    # Create one MCP client per WebSocket connection so that each browser
    # tab gets its own isolated FastMCP session.
    client = Client(mcp)
