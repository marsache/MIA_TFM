...
\begin{itemize}
    ...
    \item \textbf{Respuesta con modelo local desde Ollama, con acceso a la base de datos SQLite como RAG (modelo llama3.1:8b):} "Asistente: Se encontraron las siguientes piezas cuya nota más grave es A3:
